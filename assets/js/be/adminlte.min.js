      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if ((a || ((a = new e(this, i)), n.default(this).data(j, a)), 'undefined' === a[t]))
        ...
        (t.toggleSubmenu = function () {
          (this._element.siblings().show().toggleClass('show'),
            this._element.next().hasClass('show') ||
              this._element.parents(W).first().find('.show').removeClass('show').hide(),
            this._element
      ...
      return (
        ...
        (t.openTabSidebar = function (e, t) {
          ...
          if ('#' !== o && '' !== o && void 0 !== o) {
            ...
            ((!this._config.allowDuplicates && 0 === n.default('#' + l).length) ||
              this._config.allowDuplicates) &&
        ...
        (t.autoCollapse = function (e) {
          if ((void 0 === e && (e = !1), this._options.autoCollapseSize)) {
            ...
            n.default(window).width() <= this._options.autoCollapseSize
              ...
              : !0 === e && (t.hasClass(We) ? t.removeClass(We) : t.hasClass(Ge) && this.expand());
          }
        }),
        (t.remember = function () {
      ...
      return (
        ...
        (a._parseItem = function (e, t) {
          ...
          if ((void 0 === t && (t = []), !n.default(e).hasClass('nav-header'))) {
            ...
            if (((i.name = this._trimText(r)), (i.link = l), (i.path = t), 0 === s.length))
              ct.push(i);
            else {
