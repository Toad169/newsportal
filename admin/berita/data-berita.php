      ...
      <div class="data-card">
        ...
        <div class="data-card-body">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="index.php?page=edit-berita&id=<?= $data['id_post'] ?>" class="btn-action btn-action-warning" title="Edit">
                      <i class="fas fa-edit"></i>
                    </a>
                    <a href="index.php?page=hapus-berita&id=<?= $data['id_post'] ?>" class="btn-action btn-action-danger" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
          ...
          <div class="empty-state">
            ...
            <p>Belum ada postingan berita yang ditambahkan.</p>
          </div>
          <?php endif; ?>
        </div>
      </div>
