...
if (isset($_POST['submit'])) {
  ...
  if (in_array($ekstensi, $ekstensi_boleh) === true) {
    if ($ukuran < 2000000) {
      ...
      $sql = mysqli_query(
        $con,
        "INSERT INTO tbl_posts (img, judul, artikel, date, kategori, author, id_kategori) VALUES ('$gambar', '$judul', '$artikel', '$date', '$kategori', '$author', '$id_kategori')",
      );
