				...
				<form method="POST">
					<div class="row">
						<div class="col-lg-12">
							...
							<input type="text" name="nama_kategori" placeholder="Masukkan Nama Kategori" class="form-control" value="<?= $data[
         'nama_kategori'
       ] ?>" required>
						</div>
						<div class="col-lg-12 mt-3">
							<label for="slug">Slug (URL-friendly)</label>
							<input type="text" name="slug" placeholder="contoh: berita-terkini" class="form-control" value="<?= $data[
         'slug'
       ] ?>" required>
						...
						<div class="col-lg-12 mt-3">
							...
							<textarea class="form-control" name="deskripsi" cols="30" rows="5" placeholder="Masukkan deskripsi kategori (opsional)"><?= $data[
         'deskripsi'
       ] ?></textarea>
						</div>
						<div class="col-lg-12 mt-3">
...
<?php if (isset($_POST['submit'])) {
  ...
  $check_slug = mysqli_query(
    $con,
    "SELECT * FROM tbl_categories WHERE slug='$slug' AND id_kategori != '$id'",
  );
  ...
  $sql = mysqli_query(
    $con,
    "UPDATE tbl_categories SET nama_kategori='$nama_kategori', slug='$slug', deskripsi='$deskripsi' WHERE id_kategori='$id'",
  );
