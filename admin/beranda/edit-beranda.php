          ...
          <form method="POST" enctype="multipart/form-data" id="editForm">
            ...
            <div class="form-row-modern">
              <div class="form-group-modern">
                ...
                <select name="id_kategori" id="id_kategori" class="form-control-modern" required>
                  ...
                  while ($kat = mysqli_fetch_array($kategori_query)):
                    $selected = $data['id_kategori'] == $kat['id_kategori'] ? 'selected' : '';
                  ?>
              ...
              <div class="form-group-modern">
                ...
                <div class="current-image">
                  <div style="font-size: 12px; color: #6b7280; margin-bottom: 4px;">Gambar saat ini:</div>
                  <img src="../assets/file/post/<?= htmlspecialchars($data['img']) ?>" alt="Current image">
                </div>
                <?php endif; ?>
                <div class="file-info">
            ...
            <div class="form-group-modern">
              ...
              <textarea 
                ...
                required
              ><?= htmlspecialchars($data['artikel']) ?></textarea>
            </div>
  ...
  if (!empty($gambar)) {
    if (in_array($ekstensi, $ekstensi_boleh) === true) {
      if ($ukuran < 2000000) {
        ...
        $sql = mysqli_query($con, "UPDATE tbl_posts SET img='$gambar', judul='$judul', artikel='$artikel', kategori='$kategori', id_kategori='$id_kategori' WHERE id_post='$id'");
