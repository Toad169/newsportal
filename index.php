	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark p-2">
	  <div class="container-fluid">
	    <a class="navbar-brand d-flex align-items-center" href="#">
	    	<img src="assets/img/be/img/logo.png" width="24" height="24">
	    	&nbsp; <span>PPLG News</span>
	    </a>
	    ...
	    <div class="collapse navbar-collapse" id="navbarScroll">
	      ...
	      <form class="d-flex me-2" method="GET" action="index.php">
	        ...
	        <input class="form-control me-2" type="search" name="q" placeholder="Cari berita..." aria-label="Search" value="<?= isset(
           $_GET['q'],
         )
			...
			<div class="container header-box mt-3">
				<div class="row">
					<div class="col-md-12 text-center">
						<img src="assets/img/be/img/logo.png" class="img-fluid" width="100" height="100">
		...
		<div class="container">
			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item active" aria-current="page"><?= isset($_GET['page'])
         ? ucfirst($_GET['page'])
         : 'Beranda' ?></li>
			  </ol>
			</nav>
