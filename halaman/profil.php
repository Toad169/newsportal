...
if (isset($_POST['update'])) {
  ...
  $update_sql = mysqli_query(
    $con,
    "UPDATE tbl_users SET nama_pengguna='$nama_pengguna' WHERE id_user='$user_id'",
  );
		...
		<div class="card-body">
			...
			<form method="POST">
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="username" value="<?= htmlspecialchars(
       $user_data['username'],
     ) ?>" disabled>
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="nama_pengguna" name="nama_pengguna" value="<?= htmlspecialchars(
       $user_data['nama_pengguna'],
     ) ?>" required>
				</div>
				<div class="mb-3">
					<label for="email" class="form-label">Email</label>
					<input type="email" class="form-control" id="email" name="email" value="<?= isset(
       $user_data['email'],
     )
