<?php 
	...
	if(!empty($search_term)) {
		$query = mysqli_query($con, "SELECT * FROM tbl_posts 
...
<div class="col-lg-12">
	...
	<?php if($query && mysqli_num_rows($query) > 0): ?>
		<?php foreach($query as $data): ?>
			<div class="card mb-3">
				<div class="row g-0">
					<div class="col-md-3">
						<img src="assets/file/post/<?= $data['img'] ?>" class="img-fluid rounded-start" alt="<?= htmlspecialchars($data['judul']) ?>" style="height: 150px; width: 100%; object-fit: cover;">
					</div>
					<div class="col-md-9">
						<div class="card-body">
							<h5 class="card-title">
	...
	<?php elseif(!empty($search_term)): ?>
		<div class="alert alert-info">
			<p class="mb-0">Tidak ada hasil ditemukan untuk "<strong><?= htmlspecialchars($search_query) ?></strong>"</p>
